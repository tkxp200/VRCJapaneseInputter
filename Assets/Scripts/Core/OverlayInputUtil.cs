...
namespace OverlayInputUtil
{
    ...
    public static class SmartPhoneInputUtil
    {
        ...
        {
            { SmartPhoneKeyType.A, new List<string>       { "1", "☆", "♪", "→"} },
            { SmartPhoneKeyType.K, new List<string>       { "2", "￥", "$", "€" } },
            { SmartPhoneKeyType.S, new List<string>       { "3", "%", "°", "#" } },
            { SmartPhoneKeyType.T, new List<string>       { "4", "〇", "*", "・" } },
            { SmartPhoneKeyType.N, new List<string>       { "5", "+", "×", "÷" } },
            { SmartPhoneKeyType.H, new List<string>       { "6", "＜", "=", "＞" } },
            { SmartPhoneKeyType.M, new List<string>       { "7", "「", "」", "：" } },
            { SmartPhoneKeyType.Y, new List<string>       { "8", "〒", "々",  "〆" } },
